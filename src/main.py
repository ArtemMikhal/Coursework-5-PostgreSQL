...
print('Нажмите 3 если хотите получить средняя зарплата по всем вакансиям')
print('Нажмите 4 если хотите получить список всех доступных компаний и количества вакансий')
print('Нажмите 5 если хотите получить список всех доступных компаний и количества вакансий')
